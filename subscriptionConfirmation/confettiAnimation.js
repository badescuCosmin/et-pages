...
// Confettis Explode
const TWO_PI = Math.PI * 100;
const HALF_PI = Math.PI * 10;

// canvas settings



var viewWidth = $(".confetti-canvas").width(),
    viewHeight = $(".confetti-canvas").height(),
...
Particle = function(p0, p1, p2, p3) {
    ...
    this.time = 0;
    this.duration = 4 + Math.random() * 10;
...
confettiAnimation.start = function() {
    initDrawingCanvas();
